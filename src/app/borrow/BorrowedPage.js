...
class BorrowedPage extends React.Component {
            ...
            <Dialog open={this.state.formOpen} onClose={this.closeForm} aria-labelledby="form-dialog-title">
                ...
                <DialogContent className={classes.formBox}>
                    <Grid container spacing={1}>
                        <Grid item xs={6}>
                            <span className={classes.formText}>I borrowed</span>
                        </Grid>
                        <Grid item xs={6}>
                            <TextField
                        ...
                        <Grid item xs={6}>
                            <span className={classes.formText}>From</span>
                        </Grid>
                        <Grid item xs={6}>
    ...
    renderStatusIcon = (classes, reminder) => {
        if(reminder.status === 'returned') {
           return (<CheckCircleIcon color="primary" className={classes.statusIcon}/>);
        }
        ...
        if(dueTime >= currentTime) {
            ...
            return (<ErrorOutlineIcon color="secondary" className={classes.statusIcon}/>);
        }
    };
    ...
    render() {
        // TODO: Extract common code from LendPage and BorrowedPage
